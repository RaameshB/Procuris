    ...
    <div className="min-h-screen bg-pg-base flex items-center justify-center p-4">
      ...
      <div className="w-full max-w-sm animate-slide-up">
        ...
        <div className="bg-pg-surface rounded-2xl border border-pg-border p-6 card-shadow">
          <p className="text-sm font-semibold text-white mb-5">Sign in to your account</p>

          <form onSubmit={handleLogin} className="space-y-3">
            <div>
              <label className="text-xs text-slate-500 mb-1.5 block uppercase tracking-wide">Email</label>
              <input
                type="email"
                value={email}
            ...
            <div>
              <label className="text-xs text-slate-500 mb-1.5 block uppercase tracking-wide">Password</label>
              <input
                type="password"
                value={password}
          ...
          <div className="relative my-4">
            ...
            <div className="relative flex justify-center">
              <span className="bg-pg-surface px-2 text-xs text-slate-600">or</span>
            </div>
          </div>
